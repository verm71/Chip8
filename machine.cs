...
namespace chip8
{
    class Machine
    {
        ...
        private void RunCPU()
        {
            ...
            byte inkey = 0xff; // Default 'no key'/'key not found' 
                    ...
                    case 0xf:
                        {
                            switch (kk)
                            {
                                ...
                                case 0x0a:
                                    {
                                        if (inkey == 0xff)   // if we're not waiting for a key to be released
                                        {
                                        ...
                                        else  // inkey contains a key that we are waiting to be released
                                        {
                                            VReg[Vx] = (byte)inkey;
